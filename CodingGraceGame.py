...
def start_new_adventure(player_info_arg):
    while True:
        print_new_dungeon()
        print("You see six doors: red, blue, green, purple, orange, and white.")
        ...
        if door.startswith("red"):
            ...
            room_result = purple_waterfall_room(player_info_arg)
        elif door.startswith("orange"):
            room_result = orange_flame_room(player_info_arg)
        elif door.startswith("white"):
            room_result = white_sanctuary_room(player_info_arg)
        else:
